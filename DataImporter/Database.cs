...
namespace DataImporter
{
  class Database
  {
    ...
    private ulong InsertStreet(Street street, ulong zoneID)
    {
      ...
      string commandText = "INSERT INTO street (NAME, ZONE_ID) " +
      "VALUES (@1, @2); " +
      "SELECT LAST_INSERT_ID()";
      ...
      // Insert aliases
      commandText = "INSERT INTO street (NAME, IS_ALIAS, STREET_MASTER_ID) VALUES (@1, 1, @2)";
    ...
    public ulong FindOrCreateZone(Zone zone)
    {
      ...
      {
        zoneSearchString = $"COMMUNITY_KEY = '{zone.CommunityKey}'";
      }
      else
      {
        zoneSearchString = $"ZONE_NAME = '{zone.Name}'";
      }
